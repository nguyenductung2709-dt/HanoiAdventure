...
import o1.adventure.{Adventure, QuocTuGiam}
...
object AdventureGUI extends SimpleSwingApplication:
  ...
  def top = new MainFrame:
    ...
    val locationInfo = new TextArea(7, 80):
      ...
      wordWrap = true
      lineWrap = true
      background = new Color(243, 243, 243) // Light Green
    val turnOutput = new TextArea(7, 80):
      editable = false
      wordWrap = true
      lineWrap = true
      background = new Color(243, 243, 243) // Misty Rose
    val input = new TextField(40):
      minimumSize = preferredSize
      background = new Color(243, 243, 243) // Lemon Chiffon
    ...
    def updateInfo(info: String) =
      ...
      if this.player.location == QuocTuGiam then
        this.locationInfo.text = this.player.location.fullDescription + "\n\n" + QuocTuGiam.currentQuestion + "\n\n" + "Your stamina is: " + this.player.currentStamina + "/100.0"
